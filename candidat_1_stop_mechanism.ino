...
void moveRobot(float value, float speed, char type, bool callibFlag)
{
  ...
  if (type == 'T')
  {
    ...
    float countsPerCm = 520.0 / c; // encoder counts per cm based on your setup
...
{
  Task newTask = {type, value, speed, calibrationEnd, calibrationRollbackDist};
